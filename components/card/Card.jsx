...
const Card = ({ image, heading1, heading2, styles,alt }) => {
  return (
    <div className="cursor-pointer max-[1040px]:w-[29rem]  border-[rgba(198, 206, 211, 1)] group flex h-[30rem] w-[28.5rem] max-[500px]:w-[40rem] max-[500px]:h-[40rem] flex-col items-center  justify-center gap-[3rem] overflow-hidden rounded-25 border-2 border-solid bg-[#F0F0F0] p-12 duration-300 ease-linear hover:border-0 hover:bg-black ">
