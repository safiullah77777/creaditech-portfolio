...
const Slider = () => {
  return (
    <Link
      href={"/contact-us"}
      className="group flex border-y-[6px] border-solid border-[#5B5E71] bg-[#C6CED3] w-full  max-[850px]:border-[#3D404E]"
    >
      <div className="relative  flex flex-1 items-center gap-[1rem] bg-white py-[2rem] px-[2rem] max-[850px]:w-full  max-[850px]:flex-col max-[850px]:gap-[5rem] max-[850px]:py-[6rem]  min-[850px]:pl-[6rem]">
        <p className="clash relative max-w-[30rem]  text-[5.5rem] font-600 leading-[90%] text-[#3D404E] max-[850px]:text-center  max-[850px]:text-[#3D404E] max-[640px]:text-[4rem]">
          Have a Question?
        </p>
      ...
      <div className="relative flex max-w-[33rem] items-center gap-9 overflow-hidden duration-300 ease-linear after:absolute after:top-0 after:-left-[500%] after:h-full after:w-[90rem] after:bg-[yellow] after:duration-700 after:ease-linear group-hover:after:left-0 max-[850px]:hidden">
        <p className="clash z-20 my-[2rem] ml-[6rem] max-w-[29rem] bg-[trasnparent] text-[4.5rem] font-400 leading-[90%] text-[#1E1E1E] max-[640px]:text-center max-[640px]:text-[4rem]">
          Start your Project
        </p>
      </div>
    </Link>
