...
const PriceCard = ({ item, no }) => {
  return (
    <div className=" card-price flex w-[40rem] max-[1080px]:w-[38rem] rounded-[10px] border-[2px] border-solid ">
      <div className="flex w-full flex-col items-center justify-center  px-[5rem] py-[3rem]">
        ...
        <p className="clash py-[1rem] text-center text-[28px] font-[500] leading-[80%] text-[#000000] ">
          {no === 0 ? "Silver" : no === 1 ? "Gold" : "Platinum"} Package
        </p>
        <p className="clash pb-[2rem] text-center text-[35px] font-[500] leading-[80%] text-[#C6CED3]  ">
          {item.price}
        </p>
        ...
        <p className="clash py-[1rem] text-center text-[25px] font-[500] leading-[80%] text-[#000000]">
          ADD-ONS
        </p>
