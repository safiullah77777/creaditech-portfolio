...
const Portfolio = () => {
  ...
  return (
    <>
      <Header />
      <div
        className="banner4 relative flex min-h-[80vh] w-full justify-center bg-cover  bg-center bg-no-repeat pl-28 bg-blend-overlay max-[850px]:h-[624px]  max-[850px]:flex-col max-[850px]:p-0 
