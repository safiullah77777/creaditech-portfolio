...
const AboutUs = () => {
  return (
    <>
      ...
      <div className="banner6 relative flex h-[100vh] w-full  bg-cover bg-center bg-no-repeat  bg-blend-overlay max-[850px]:h-[850px] max-[850px]:flex-col max-[850px]:p-0 ">
